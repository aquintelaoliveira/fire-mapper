...
namespace FireSource.Test
{
    ...
    {
        const string FIREBASE_PROJECT_ID = "fire-students-89ad3";
        const string FIREBASE_CREDENTIALS_PATH = "Resources/fire-students-89ad3-firebase-adminsdk-bsgu6-fc42f76265.json";
